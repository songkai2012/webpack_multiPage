...
moduleExports.test = path.resolve(moduleExports.root,"./test");   //项目测试文件目录
moduleExports.resource = path.resolve(moduleExports.src,"./resource");   //项目公共资源文件
moduleExports.resourceTest = path.resolve(moduleExports.test,"./resource");   //项目测试公共资源文件
moduleExports.output = path.resolve(moduleExports.root,"./server/views");   //输出文件
